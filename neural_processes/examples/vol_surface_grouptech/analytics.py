"""
Analytics for the Group Tech CNP experiment. Loads model.pt from out_dir.

Run from repo root:
    .venv/bin/python3 -m neural_processes.examples.vol_surface_grouptech.analytics
    .venv/bin/python3 -m neural_processes.examples.vol_surface_grouptech.analytics --out_dir results/vol_surface_grouptech_hourly
"""
...
def main(cfg: Config, model=None, dataset=None):
    ...
    run_standard_analytics(model, dataset, cfg.analytics, out,
                           results_csv=RESULTS_CSV, experiment="vol_surface_grouptech")
