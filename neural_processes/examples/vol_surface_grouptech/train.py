"""
Train CNP on Group Tech US market data. Saves model.pt and training_curve.png.

Run from repo root:
    .venv/bin/python3 -m neural_processes.examples.vol_surface_grouptech.train
    .venv/bin/python3 -m neural_processes.examples.vol_surface_grouptech.train --device cpu --n_train 200 --n_epochs 50
"""
