"""
Train a delta-CNP on Group Tech US daily data.

The model predicts the IV increment (today minus a BSpline prior built from
yesterday's full observations) rather than the absolute IV level.

Run from repo root:
    .venv/bin/python3 -m neural_processes.examples.vol_surface_increment.train
    .venv/bin/python3 -m neural_processes.examples.vol_surface_increment.train --device cpu --n_epochs 10
"""
